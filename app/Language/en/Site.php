...
return [
   ...
   'page'    => [
	   ...
	   'developers' => [
		   ...
		   'api_access'               => 'The api can be accessed by through <ul><li>REST: {0}</li><li>Graphql: {1}</li></ul>',
		   'api_parameters'           => 'Accessing Rates',
		   'api_brief'                => 'There are a total of four possible query parameter combinations (GET | POST) that can be passed to get data from both the RESTful and Graphql Api namely:',

		   'param_name_title'         => '<code>search</code>',
		   'param_name'               => 'Allows you to get currency rates using only part of a name of said currency',
		   ...
		   'param_date'               => 'When provided only matching rate after this date will be returned. Accepts common date formats, though a unix time stamp is preferred.',
		   ...
		   'graphql_intro'            => 'Unlike REST, graphql allows you to structure the responses however you like, even reducing the number of requests made to the server in one go.',
		   'graphql_recommend'        => 'Using a Graphql schema browser is highly recommended to fully explore the api. You may use the example as a starting point as the possibilities of graphql are beyond the scope of this documentation.',
	   ],
	   'faq'        => [
