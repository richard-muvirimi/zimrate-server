                ...
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        ...
	                        <div class="hero-cta"><a class="button button-primary" href="#rates"><?php echo $this->lang->line('rates'); ?></a><a class="button" href="developers"><?php echo $this->lang->line('developers'); ?></a></div>
						</div>
                        ...
                        <div class="features-wrap">
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title mt-24"><?php echo $this->lang->line('benefit_productive_title'); ?></h4>
							...
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title mt-24"><?php echo $this->lang->line('benefit_time_title'); ?></h4>
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title mt-24"><?php echo $this->lang->line('benefit_free_title'); ?></h4>
			...
			<section class="cta section">
				<div class="container">
					<div class="cta-inner section-inner">
						...
						<div class="cta-cta">
							<a class="button button-primary button-wide-mobile" href="https://tyganeutronics.com/#contact-form-2"><?php echo $this->lang->line('contact_btn'); ?></a>
						</div>
					</div>
				</div>
			</section>
